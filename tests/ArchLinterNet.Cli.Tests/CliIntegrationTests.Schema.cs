...
[TestFixture]
internal sealed class CliSchemaIntegrationTests : CliIntegrationTestBase
{
    [Test]
    public void SchemaList_UsesThePackagedReleaseRegistry()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(stdout, Does.Contain("policy-root\tv1\thttps://archlinternet.dev/schema/0.8.0/"));
            Assert.That(stdout, Does.Contain("baseline\tv3\t"));
