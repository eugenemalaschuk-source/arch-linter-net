...
public sealed partial class BaselineCommandHandlerTests
{
    ...
    public void BaselineMigrate_Success_WritesYamlAndFormatsJsonAndHumanOutput()
    {
        ...
        int jsonResult = new BaselineMigrateCommandHandler(runtime, jsonConsole, fileSystem).Execute(
            new BaselineMigrateCommandOptions("policy.yml", "baseline.yml", "migrated.yml", "all", "ci", "json", _contractIds, false, false));
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(runtime.MigrateRequest!.ContractIds, Is.EqualTo(_contractIds));
        ...
        int humanResult = new BaselineMigrateCommandHandler(runtime, humanConsole, fileSystem).Execute(
            new BaselineMigrateCommandOptions("policy.yml", "baseline.yml", "migrated.yml", "all", "ci", "human", Array.Empty<string>(), false, false));
    ...
    public void BaselineMigrate_Ambiguous_DoesNotWriteAndFailsClosed()
    {
        ...
        int result = new BaselineMigrateCommandHandler(runtime, console, fileSystem).Execute(
            new BaselineMigrateCommandOptions("policy.yml", "baseline.yml", "migrated.yml", "all", null, "human", Array.Empty<string>(), false, false));
    ...
    public void BaselineMigrate_ApplicationServiceError_ReportsErrorAndDoesNotWrite()
    {
        ...
        int result = new BaselineMigrateCommandHandler(runtime, console, fileSystem).Execute(
            new BaselineMigrateCommandOptions("policy.yml", "baseline.yml", "baseline.yml", "all", null, "human", Array.Empty<string>(), false, false));
    ...
    public void BaselineMigrate_GuardsAndException_ReportErrors()
    {
        AssertGuardCase(console => new BaselineMigrateCommandHandler(new StubRuntime(), console, new StubFileSystem("policy.yml", "baseline.yml")).Execute(
                new BaselineMigrateCommandOptions("policy.yml", "baseline.yml", "out.yml", "invalid", null, "json", Array.Empty<string>(), false, false)),
            "Invalid mode");

        AssertGuardCase(console => new BaselineMigrateCommandHandler(new StubRuntime(), console, new StubFileSystem("policy.yml", "baseline.yml")).Execute(
                new BaselineMigrateCommandOptions("policy.yml", null, "out.yml", "strict", null, "json", Array.Empty<string>(), false, false)),
            "--baseline is required");

        AssertGuardCase(console => new BaselineMigrateCommandHandler(new StubRuntime(), console, new StubFileSystem("policy.yml", "baseline.yml")).Execute(
                new BaselineMigrateCommandOptions("policy.yml", "baseline.yml", null, "strict", null, "json", Array.Empty<string>(), false, false)),
            "--output is required");
