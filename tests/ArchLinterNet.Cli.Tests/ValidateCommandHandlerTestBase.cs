...
// iterations.
internal abstract partial class ValidateCommandHandlerTestBase
{
    [System.Text.RegularExpressions.GeneratedRegex("Architecture validation passed.")]
    protected static partial System.Text.RegularExpressions.Regex ArchitectureValidationPassedRegex();
    ...
    protected sealed class FakeCliConsole(int errorWriteFailures = 0, int outputWriteFailures = 0) : ICliConsole
    {
