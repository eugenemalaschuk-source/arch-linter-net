...
public sealed class ArchitectureContractHandlerRegistryTests
{
    ...
    [Test]
    public void Execute_LayerTemplateIdConflictValidation_IsModeLocal()
    {
        var document = new ArchitectureContractDocument
        {
            Version = 1,
            ...
            Contracts = new ArchitectureContractGroups
            {
                ...
                // but only on the audit side - strict has no templates and must stay unaffected.
        ...
        Assert.Throws<InvalidOperationException>(() => ArchitectureContractExecutor.Execute(auditRunner, document, "audit"));
    }
}
