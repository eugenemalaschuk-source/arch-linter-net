...
// the ArchLinterNet.Cli.Tests process registers the guard with enforce: false because it runs
// tests under 8-way parallelism, where a test's wall-clock time is dominated by CPU contention
// and a hard per-test gate would be non-deterministic — there over-limit tests are demoted to
// warnings.
[assembly: ArchLinterNet.Core.Tests.PerTestDurationGuard]
