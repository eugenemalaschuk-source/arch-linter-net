...
internal static class BenchmarkWorkloadGenerator
{
        ...
        BenchmarkTopologySummary topology)
    {
        return new BenchmarkInventoryCounts
        {
            ...
            TypeCount = dimensions.ProjectCount * dimensions.TypesPerProject * dimensions.SourceRootCount,
            ReferenceEdgeCount = topology.ReferenceEdgeCount,
            LayerCount = dimensions.LayerCount,
            SelectorMembershipCount = dimensions.ProjectCount * dimensions.LayerCount * dimensions.SelectorMembershipsPerLayer,
