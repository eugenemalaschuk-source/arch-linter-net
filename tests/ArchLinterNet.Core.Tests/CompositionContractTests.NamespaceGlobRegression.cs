...
using static ArchLinterNet.Core.Tests.CompositionContractTests;
...
// file-size lint gate.
public sealed class CompositionNamespaceGlobRegressionTests
{
    ...
    public void SetUp()
    {
        _tempDir = Path.Combine(Path.GetTempPath(), $"arch-linter-composition-glob-test-{Guid.NewGuid():N}");
