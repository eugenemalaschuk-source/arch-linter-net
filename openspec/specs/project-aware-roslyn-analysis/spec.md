# project-aware-roslyn-analysis Specification

## Purpose
Resolves accurate per-project Roslyn compilation context (real project/package/framework references, via an MSBuild design-time build) for method-body source analysis, with an explicit fallback and diagnostic when project-aware resolution isn't available.
