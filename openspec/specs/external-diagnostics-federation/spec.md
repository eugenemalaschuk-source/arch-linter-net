...
the composition. A successful trusted zero-result artifact SHALL remain explicitly evaluable and
distinct from absent or unusable evidence.
...
- **THEN** the selected imported diagnostic appears in the canonical finding, baseline, Human,
  JSON, SARIF, Testing, and applicability projections with its evidence provenance intact
