# release-provenance-verification Specification

## Purpose
Defines consumer verification of attested project-controlled release artifacts
and the project's distinct NuGet author-signing and package-SBOM decisions.
## Requirements
