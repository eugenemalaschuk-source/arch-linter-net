# input-robustness-testing Specification

## Purpose

Define how ArchLinterNet selects and safely operates fuzzing or property-based
tests for accepted untrusted-input boundaries.
## Requirements
