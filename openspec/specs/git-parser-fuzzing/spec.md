# git-parser-fuzzing Specification

## Purpose
Defines the repository's bounded, reproducible fuzzing surface for Git history
binary parsers and the rules for safely operating, triaging, and promoting
