# AI Semantic Role Governance Guidance Specification

## Purpose

Documents an AI-first workflow for authoring, reviewing, and diagnosing
semantic-role architecture policies while preserving explainable static-analysis
boundaries.
