# architecture-policy-inventory Specification

## Purpose
Provide a deterministic canonical inventory of the effective architecture policy and its explicit manual-waiver debt for Core, CLI, Testing, cache, and future reporting consumers.
## Requirements
