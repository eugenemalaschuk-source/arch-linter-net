...
- **THEN** package/entrypoint, two adopter-runtime, three consumer-cleanup, and three public-API-selector shards run as independently schedulable jobs per supported PR platform
