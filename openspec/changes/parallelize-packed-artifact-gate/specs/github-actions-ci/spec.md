...
- **THEN** package/entrypoint, adopter-runtime, consumer-cleanup, and public-API-selector shards run as independently schedulable jobs per supported PR platform
