...
ArchLinterNet SHALL provide a separate GitHub Actions workflow for official package builds and optional NuGet.org publication that runs only through `workflow_dispatch`.
