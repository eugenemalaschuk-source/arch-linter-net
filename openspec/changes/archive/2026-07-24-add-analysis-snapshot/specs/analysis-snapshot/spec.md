...
- **THEN** policy composition (policy load, baseline merge, severity validation, contract-ID selection) executes exactly once, while project discovery and assembly resolution/load may execute a second time to see the freshly built assemblies
