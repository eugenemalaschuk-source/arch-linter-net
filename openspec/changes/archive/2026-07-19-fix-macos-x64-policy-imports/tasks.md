...
- [x] 1.4 Reject Windows directories before and after handle acquisition, and classify `FILE_TYPE_UNKNOWN` failures from their captured Win32 error.
...
- [x] 2.3 Add a real Windows CI regression for directory roots and imports.
