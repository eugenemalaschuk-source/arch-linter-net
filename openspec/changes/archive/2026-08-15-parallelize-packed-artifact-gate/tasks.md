...
- [x] Validate workflow syntax/security/formatting and focused unit/tooling tests in PR CI.
- [x] Record real before/after PR timings, including the slowest Windows shard and stable fan-in critical path.
- [x] Record the next release-workflow timing evidence and verify only the immutable-candidate Checkpoint B matrix executes packed-adopter proof.
