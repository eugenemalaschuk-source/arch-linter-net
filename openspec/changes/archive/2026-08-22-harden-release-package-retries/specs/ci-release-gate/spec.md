...
publish or attach only the same manifest-selected digest-verified subjects. Any
manifest-verification step that uses Bash environment-variable syntax SHALL
