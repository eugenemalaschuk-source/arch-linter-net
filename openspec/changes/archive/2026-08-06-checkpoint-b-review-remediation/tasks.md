## 1. Executable Checkpoint B scenarios

- [x] 1.1 Return generic CI, documented command, non-TTY, and cancellation results from their executed oracles.
- [x] 1.2 Add deterministic in-flight Testing and CLI cancellation checks with output/cache cleanup assertions.
