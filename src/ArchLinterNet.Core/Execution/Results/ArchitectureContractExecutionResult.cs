    ...
    IReadOnlyCollection<ArchitectureCoverageSummary> CoverageSummaries)
{
    ...
    // Applicability is opt-in. Existing families leave both collections empty and completion null,
    // preserving the pre-v0.8 execution shape while giving future family handlers one canonical
    // transport boundary for expected membership and produced evidence.
