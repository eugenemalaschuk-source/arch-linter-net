...
public sealed class ArchitectureProjectDiscoveryService : IArchitectureProjectDiscoveryService
{
    ...
    public ArchitectureProjectDiscoveryService(IArchitectureFileSystem fileSystem)
        : this(fileSystem, new ArchitectureSolutionParser(), new ArchitectureProjectFileParser())
    {
    }

    internal ArchitectureProjectDiscoveryService(
        IArchitectureFileSystem fileSystem,
        IArchitectureSolutionParser solutionParser,
        IArchitectureProjectFileParser projectFileParser)
    {
