...
internal static class ArchitectureContractFamilyBindings
{
    internal static readonly IReadOnlyList<ArchitectureContractFamilyBinding> All = new[]
    {
        ...
        new ArchitectureContractFamilyBinding("layout_convention_applicability", g => g.StrictLayoutConventionApplicability,
            g => g.AuditLayoutConventionApplicability, true),
        ...
        new ArchitectureContractFamilyBinding("versioned_contract_surface_isolation",
            g => g.StrictVersionedContractSurfaceIsolation, g => g.AuditVersionedContractSurfaceIsolation, true),
        ...
        new ArchitectureContractFamilyBinding("metric_budgets", g => g.StrictMetricBudgets, g => g.AuditMetricBudgets, true),
