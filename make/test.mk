...
TEST_E2E_FIXTURES := FullyQualifiedName~ExternalDependencyContractAuditE2eTests|FullyQualifiedName~BuildStatePreflightTests|FullyQualifiedName~BuildStatePreflightConsumedInputsTests|FullyQualifiedName~BuildStatePreflightAssemblyReloadTests|FullyQualifiedName~CheckpointAAdoptionAcceptanceTests|FullyQualifiedName~ArchitectureBaselineIntegrationTests|FullyQualifiedName~SelfArchitecturePolicyTests|FullyQualifiedName~SelfPolicyNegativeRegressionTests|FullyQualifiedName~RepeatedWorkRegressionEvidenceTests|FullyQualifiedName~TopologyReviewLifecycleAcceptanceTests|FullyQualifiedName~EnsureBuiltNonDestructiveIntegrationTests|FullyQualifiedName~AspNetSharedFrameworkAcceptanceTests|FullyQualifiedName~ArchitectureProjectRoslynContextResolverTests|FullyQualifiedName~ArchitectureAnalysisSessionMethodBodyProjectAwareTests
TEST_E2E_FILTER := $(TEST_E2E_FIXTURES)
TEST_PACKED_ARTIFACT_FILTER := FullyQualifiedName~CheckpointBReleaseGateTests
TEST_UNIT_FILTER := FullyQualifiedName!~ExternalDependencyContractAuditE2eTests&FullyQualifiedName!~BuildStatePreflightTests&FullyQualifiedName!~BuildStatePreflightConsumedInputsTests&FullyQualifiedName!~BuildStatePreflightAssemblyReloadTests&FullyQualifiedName!~CheckpointAAdoptionAcceptanceTests&FullyQualifiedName!~ArchitectureBaselineIntegrationTests&FullyQualifiedName!~SelfArchitecturePolicyTests&FullyQualifiedName!~SelfPolicyNegativeRegressionTests&FullyQualifiedName!~RepeatedWorkRegressionEvidenceTests&FullyQualifiedName!~TopologyReviewLifecycleAcceptanceTests&FullyQualifiedName!~EnsureBuiltNonDestructiveIntegrationTests&FullyQualifiedName!~AspNetSharedFrameworkAcceptanceTests&FullyQualifiedName!~ArchitectureProjectRoslynContextResolverTests&FullyQualifiedName!~ArchitectureAnalysisSessionMethodBodyProjectAwareTests&FullyQualifiedName!~CheckpointBReleaseGateTests
